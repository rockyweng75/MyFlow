...
export default {
    ...
    setup() {
        ...
        const list = computed(() =>{
            return store.getters['deadline/datalist']
        })
        ...
        const pageIndex = computed({
            get: () => {
                return store.getters['deadline/pageIndex']
            },
            set: val => {
                store.commit('deadline/setPageIndex', val)
            }
        })

        const rowNumber = computed(() =>{
            return store.getters['deadline/rowNumber']
        })

        const total = computed(() =>{
            return store.getters['deadline/total']
        })

        const query = () =>{
            store.dispatch('deadline/getDeadlines', state.queryForm)
        }
