...
export default {
    ...
    setup() {
        ...
        const list = computed(() =>{
            return store.getters['approveList/dataList']
        })
        ...
        const pageIndex = computed({
            get: () => {
                return store.getters['approveList/pageIndex']
            },
            set: val => {
                store.commit('approveList/setPageIndex', val)
            }
        })

        const rowNumber = computed(() =>{
            return store.getters['approveList/rowNumber']
        })

        const total = computed(() =>{
            return store.getters['approveList/total']
        })

        const query = () =>{
            store.dispatch('approveList/getApproveList')
        }
