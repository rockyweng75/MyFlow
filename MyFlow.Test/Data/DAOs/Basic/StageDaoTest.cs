...
{
    public class StageDaoTest : BasicTestServer
    {
        ...
        public void init() 
        {
            ...
            dao = scope.ServiceProvider.GetService<IStageDao>();
        }
        ...
        private MyFlow.Data.Models.Stage? getOne { get; set; }
        [Test, Order(2)]
